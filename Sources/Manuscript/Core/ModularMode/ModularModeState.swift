...
final class ModularModeState: ObservableObject {
    ...
    private func buildGroups() -> [CardGroup] {
        ...
        case .flat:
            ...
            return [CardGroup(id: "flat", title: "All Scenes", cards: cards, matchingCount: activeFilters.isActive ? cards.count : nil)]
        ...
        case let .byTag(tagId):
            ...
            return [CardGroup(id: tagId.uuidString, title: "Tag", cards: cards, matchingCount: activeFilters.isActive ? cards.count : nil)]
        ...
        case .byStatus:
            return ContentStatus.allCases.map { status in
                ...
                return CardGroup(id: status.rawValue, title: status.rawValue, cards: cards, matchingCount: activeFilters.isActive ? cards.count : nil)
            }
        }
    }
}
